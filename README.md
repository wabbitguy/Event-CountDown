...
This is a customizable bit of code for an ESP32 based Crowpanel V2.2. It uses the standard WIFI libraries and TFT_eSPI (there's a user setup file available that works with the V2.2 Crowpanel (User_Setup.h). There are also two bitmaps (24 bit BMP format) that are shown leading up to the event date and then one for the actual event day. Time is obtained via the NTP servers ever couple of hours.
...
![Christmas Countdown](https://github.com/user-attachments/assets/7de1e11a-5991-4f4f-b762-635991007bcb)
...
![Christmas CountDown Back](https://github.com/user-attachments/assets/641caaed-fdd4-44bd-810a-c5ef70c7fdd9)
